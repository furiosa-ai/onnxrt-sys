...
[![docs](https://img.shields.io/badge/docs-0.20.0-blue.svg)](https://furiosa-ai.github.io/onnxrt-sys/0.20.0/onnxrt_sys/)
...
```toml
[dependencies]
onnxrt-sys = { git = "https://github.com/furiosa-ai/onnxrt-sys", tag = "0.20.0" }
```
